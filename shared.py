...
_STOCK_NEWS = {
    "DONOVAN": [
        ...
        {"headline": "Donovan tries day trading — loses entire portfolio in 11 minutes", "impact": (-18, -7)},
        {"headline": "Donovan declares himself 'sigma male' — market interprets as bearish", "impact": (-9, -2)},
        {"headline": "Donovan accidentally becomes CEO of a startup for 47 minutes", "impact": (6, 14), "linked": [("DONOVAN", (8, 20))]},
        {"headline": "Donovan's LinkedIn post gets 3 likes — he calls it a victory", "impact": (-7, 3)},
        {"headline": "Donovan tries to unionize his own Discord server", "impact": (-8, -1)},
        {"headline": "Donovan claims he predicted this crash — timestamp shows otherwise", "impact": (-11, -4)},
        {"headline": "Donovan buys the dip... with margin... at 3am", "impact": (-22, -9)},
        {"headline": "{member} leaks Donovan's Spotify Wrapped — it's all sad white boy music", "impact": (-10, -3)},
        {"headline": "Donovan attempts to explain his portfolio — even he gets lost", "impact": (-13, -5)},
        {"headline": "Donovan says 'this is the bottom' — market immediately finds new bottom", "impact": (-15, -6)},
        {"headline": "Donovan gets ratio'd by Wendy's Twitter again", "impact": (-12, -4), "linked": [("WENDY", (5, 12))]},

        # === SUPER UNHINGED {member} HEADLINES ===
        {"headline": "{member} accidentally live-streams himself crying over expired milk — stock plummets", "impact": (-19, -8)},
        {"headline": "{member} tries to fight a vending machine at 4am outside Taco Bell — goes viral", "impact": (-14, 12), "linked": [("TBELL", (5, 15))]},
        {"headline": "{member} declares himself President of his Discord server and immediately gets impeached", "impact": (-17, -6)},
        {"headline": "{member} leaks his own nudes but it's just pictures of his unhinged portfolio", "impact": (-22, -9)},
        {"headline": "{member} gets caught trying to snort lines of crushed-up Big Mac sauce packets in Ohio", "impact": (-25, 15), "linked": [("BIGMAC", (-10, -3)), ("OHIO", (-30, 30))]},

        {"headline": "{member} tries to comfort Donovan during a breakdown — accidentally makes it worse", "impact": (-18, -7)},
        {"headline": "{member} and Donovan start a podcast — it lasts 11 minutes before they fight", "impact": (-15, 6)},
        {"headline": "{member} catches Donovan stress-eating Big Macs at 3am — live on stream", "impact": (-20, -9), "linked": [("BIGMAC", (-8, -2))]},
        {"headline": "{member} leaks Donovan's search history titled 'how to not be a loser'", "impact": (-22, -10)},
        {"headline": "{member} challenges Donovan to a boxing match — Donovan taps out in the parking lot", "impact": (-17, -5)},

        # === MAXIMUM UNHINGED ===
        {"headline": "{member} catches Donovan balls-deep in a Taco Bell Crunchwrap Supreme wrapper — calls it performance art", "impact": (-40, -20)},
        {"headline": "{member} pegs Donovan with a frozen Big Mac while he cries about his shorts", "impact": (-45, 25), "linked": [("BIGMAC", (-20, -10))]},
        {"headline": "{member} forces Donovan to eat his own cum off a torta at 4am in Ohio", "impact": (-55, -25), "linked": [("TORTA", (20, 35)), ("OHIO", (-60, 60))]},
        {"headline": "{member} sells Donovan’s used underwear as NFTs — they somehow floor at $420", "impact": (-38, 30)},
        {"headline": "{member} and Donovan 69 while watching their portfolios burn live on stream", "impact": (-50, -18)},
    ],
    ...
    "RUST": [
        ...
        {"headline": "Rust developer writes 'just one more lifetime' — dies of old age", "impact": (-7, 4)},
        {"headline": "New Rust book released — 800 pages, all error messages", "impact": (-5, 8)},
        {"headline": "Rust mascot Ferris spotted committing war crimes in production", "impact": (-9, 6)},
        {"headline": "{member} rewrites Rust project in Go for fun — immediately regrets", "impact": (-6, 5)},
        {"headline": "Rust foundation announces new governance model — still requires unsafe{}", "impact": (-4, 9)},

        # === UNHINGED {member} ===
        {"headline": "{member} tries to explain Rust lifetimes to Donovan — friendship destroyed", "impact": (-14, 8), "linked": [("RUST", (-10, -3))]},
        {"headline": "{member} rewrites entire life in Rust — still panics at runtime", "impact": (-16, 5)},
        {"headline": "{member} gets owned by the borrow checker so hard he moves to Ohio", "impact": (-19, -6), "linked": [("OHIO", (-20, 20))]},
        {"headline": "{member} names his new crate after Donovan — immediately deprecated", "impact": (-13, 7)},
        {"headline": "{member} rage-quits Rust at 4am — comes back 20 minutes later", "impact": (-12, 9)},

        # === MAXIMUM UNHINGED ===
        {"headline": "{member} gets fucked by the borrow checker so hard he now identifies as &mut self", "impact": (-35, 15)},
        {"headline": "{member} writes unsafe Rust code with his dick — compiler still calls him cringe", "impact": (-42, 22), "linked": [("RUST", (-30, -15))]},
        {"headline": "{member} tries to lifetime every hole during sex — partner blue-screens", "impact": (-48, -20)},
        {"headline": "{member} sacrifices his asshole to the Rust gods for one (1) working async function", "impact": (-40, 28)},
        {"headline": "{member} renames his prostate ‘static mut’ and lets the whole server borrow it", "impact": (-37, 25)},
    ],
    ...
    "BIGMAC": [
        ...
        {"headline": "Big Mac eaten on livestream — viewership breaks records, nutritionists cry", "impact": (7, 16)},
        {"headline": "McDonald's stock now moves inversely with Donovan's mood", "impact": (-5, 12), "linked": [("DONOVAN", (-8, -2))]},
        {"headline": "Big Mac secret sauce confirmed to contain trace amounts of hope", "impact": (4, 11)},
        {"headline": "McDonald's tests $50 Big Mac — rich people still buy it", "impact": (6, 14)},

        # === UNHINGED + MAXIMUM ===
        {"headline": "{member} attempts Big Mac eating contest against Donovan — both hospitalized", "impact": (-17, 10), "linked": [("BIGMAC", (8, 18))]},
        {"headline": "{member} proposes to a Big Mac in a viral video — McDonald's stocks it", "impact": (-15, 12)},
        {"headline": "{member} blames Big Mac for his entire personality — analysts agree", "impact": (-18, -6)},
        {"headline": "{member} gets banned from McDonald's for 'emotional support sauce packets'", "impact": (-14, 5)},
        {"headline": "{member} live-tweets his Big Mac-induced existential crisis", "impact": (-16, 8)},

        {"headline": "{member} gives birth to a sentient Big Mac in a McDonald’s bathroom — names it Donovan", "impact": (-50, 40), "linked": [("BIGMAC", (30, 60))]},
        {"headline": "{member} fucks a 40-piece McNugget bucket while screaming about inflation", "impact": (-55, -25)},
        {"headline": "{member} covers his entire body in Big Mac sauce and rolls around in Ohio", "impact": (-60, 45), "linked": [("OHIO", (-70, 70))]},
        {"headline": "{member} marries 47 Big Macs in a mass wedding — McDonald's sues for emotional damages", "impact": (-45, 50)},
        {"headline": "{member} deepfakes himself getting railed by Grimace — stock still goes up", "impact": (-52, 35)},
    ],
    ...
    "TORTA": [
        ...
        {"headline": "Torta truck declares independence from nation — new micro-nation formed", "impact": (9, 17)},
        {"headline": "Torta discovered to have higher GDP than some small countries", "impact": (8, 15)},
        {"headline": "{member} attempts world record longest torta — structural failure at 47 feet", "impact": (-8, 6)},
        {"headline": "Torta now accepted as collateral by local banks", "impact": (7, 14)},

        # === UNHINGED + MAXIMUM ===
        {"headline": "{member} starts a torta cult — Donovan becomes first follower", "impact": (-13, 14), "linked": [("TORTA", (10, 20))]},
        {"headline": "{member} fights a torta vendor at 2am — claims it was 'research'", "impact": (-19, -7)},
        {"headline": "{member} tries to smuggle 47 tortas through airport security", "impact": (-16, 6)},
        {"headline": "{member} declares torta superior to Big Mac — fast food war begins", "impact": (-15, 12), "linked": [("BIGMAC", (-10, -3))]},
        {"headline": "{member} eats torta so aggressively he ascends to a higher plane", "impact": (-12, 15)},

        {"headline": "{member} rawdogs a torta so aggressively the beans achieve sentience", "impact": (-65, 40), "linked": [("TORTA", (45, 80))]},
        {"headline": "{member} uses a family-size torta as a fleshlight then reviews it 1 star", "impact": (-70, -30)},
        {"headline": "{member} gets impregnated by a torta truck driver in the parking lot", "impact": (-58, 55)},
        {"headline": "{member} starts a OnlyFans where he exclusively sits on fresh tortas", "impact": (-48, 60)},
        {"headline": "{member} snorts torta beans off Donovan’s taint at 3am", "impact": (-75, 35), "linked": [("DONOVAN", (-50, -25))]},
    ],
    ...
    "TRUMP": [
        ...
        {"headline": "Trump posts picture of Big Mac on Truth Social — $BIGMAC +1800%", "impact": (12, 25), "linked": [("BIGMAC", (10, 22))]},
        {"headline": "Trump says 'Taco Bell is tremendous' — late night sales explode", "impact": (8, 18), "linked": [("TBELL", (6, 15))]},
        {"headline": "Trump calls Ohio 'beautiful, maybe the most beautiful' — chaos intensifies", "impact": (-12, 18), "linked": [("OHIO", (-22, 22))]},
        {"headline": "Trump threatens to buy Wendy's — Wendy's Twitter responds with fire", "impact": (5, 14), "linked": [("WENDY", (8, 20))]},

        # === UNHINGED + MAXIMUM ===
        {"headline": "{member} gets personally ratio'd by Trump on Truth Social", "impact": (-20, -8)},
        {"headline": "{member} tries to debate Trump in a Taco Bell parking lot", "impact": (-18, 10), "linked": [("TBELL", (6, 14))]},
        {"headline": "{member} wears a Trump hat ironically — immediately gets doxxed", "impact": (-17, -5)},
        {"headline": "{member} asks Trump for financial advice — market crashes instantly", "impact": (-22, 8)},
        {"headline": "{member} gets called 'low energy' by Trump — stock tanks", "impact": (-19, -7)},

        {"headline": "{member} sends Trump a dick pic with ‘thoughts on my portfolio sir?’", "impact": (-35, 20)},
        {"headline": "{member} gets adopted by Trump mid-rally — immediately disowned", "impact": (-28, 15)},
        {"headline": "{member} tries to suck up to Trump by eating a Big Mac on live TV", "impact": (-22, 18), "linked": [("BIGMAC", (15, 25))]},
        {"headline": "{member} begs Trump to piss on his portfolio for good luck", "impact": (-70, -30)},
        {"headline": "{member} gets called a ‘disgusting donkey’ by Trump on Truth Social mid-nut", "impact": (-85, -35)},
    ],
    ...
    "COCAINE": [
        ...
        {"headline": "COCAINE announces NFT collection — somehow sells out", "impact": (15, 28)},
        {"headline": "DEA vs Cartel rap battle scheduled for Q3 earnings call", "impact": (-10, 12)},
        {"headline": "COCAINE stock splits 69 times in one week — analysts applaud creativity", "impact": (12, 25)},
        {"headline": "{member} seen leaving COCAINE HQ wearing sunglasses at night", "impact": (-14, -5)},

        # === UNHINGED + MAXIMUM ===
        {"headline": "{member} becomes unwilling COCAINE brand ambassador after one bad night", "impact": (-25, 15)},
        {"headline": "{member} tries to pay for Taco Bell with COCAINE — gets lifetime ban", "impact": (-20, -10), "linked": [("TBELL", (-8, -2))]},
        {"headline": "{member} snorts lines off a Wendy's square burger", "impact": (-23, 12), "linked": [("WENDY", (10, 20))]},
        {"headline": "{member} claims COCAINE 'fixed' his portfolio — it did not", "impact": (-24, -9)},
        {"headline": "{member} gets caught with COCAINE in Ohio — locals not surprised", "impact": (-22, 18), "linked": [("OHIO", (-25, 25))]},

        {"headline": "{member} does an entire eightball off Wendy's square patties", "impact": (-32, 25), "linked": [("WENDY", (20, 30))]},
        {"headline": "{member} proposes to the COCAINE cartel leader on Discord", "impact": (-35, 18)},
        {"headline": "{member} tries to snort Taco Bell Fire Sauce thinking it was premium product", "impact": (-28, -15), "linked": [("TBELL", (-20, -8))]},
        {"headline": "{member} does so much COCAINE he fucks a hole in the fabric of spacetime", "impact": (-90, 70)},
        {"headline": "{member} rails lines of COCAINE off Wendy's ass in a Taco Bell bathroom", "impact": (-95, 55), "linked": [("WENDY", (50, 80)), ("TBELL", (-40, -20))]},
    ],
    ...
    "OHIO": [
        ...
        {"headline": "Ohio man tries to short Ohio — immediately gets possessed", "impact": (-30, 30)},
        {"headline": "Ohio declares war on Florida — both sides too distracted to fight", "impact": (-18, 22), "linked": [("FLORIDA", (-15, 15))]},
        {"headline": "Something happened in Ohio again. We are not allowed to say what.", "impact": (-28, 28)},

        # === UNHINGED + MAXIMUM ===
        {"headline": "{member} moves to Ohio thinking it would fix him — it made him worse", "impact": (-28, 25)},
        {"headline": "{member} attempts Ohio man speedrun — achieves new record", "impact": (-30, 30)},
        {"headline": "{member} gets possessed in Ohio and starts day trading", "impact": (-25, 22)},
        {"headline": "{member} tries to escape Ohio — ends up in Florida instead", "impact": (-22, 18), "linked": [("FLORIDA", (-15, 15))]},
        {"headline": "{member} becomes the final boss of Ohio", "impact": (-27, 27)},

        {"headline": "{member} becomes Ohio — literally turns into the concept of Ohio", "impact": (-150, 150)},
        {"headline": "{member} gets rawdogged by the concept of Ohio itself — twins born fully unhinged", "impact": (-200, 200)},
        {"headline": "{member} opens a portal in Ohio by fisting the ground — pure chaos leaks out", "impact": (-250, 250)},
    ],
    ...
    "FLORIDA": [
        ...
        {"headline": "Florida Man tries to eat entire Taco Bell menu in one sitting — succeeds", "impact": (6, 14), "linked": [("TBELL", (5, 12))]},
        {"headline": "Florida passes law requiring all residents to be unhinged", "impact": (-8, 12)},
        {"headline": "Florida Man becomes governor of Ohio for 20 minutes", "impact": (-22, 18), "linked": [("OHIO", (-15, 20))]},

        # === UNHINGED + MAXIMUM ===
        {"headline": "{member} commits several new felonies in Florida for content", "impact": (-20, 12)},
        {"headline": "{member} wrestles alligator while holding Taco Bell", "impact": (-18, 20), "linked": [("TBELL", (8, 15))]},
        {"headline": "{member} becomes Florida Man of the Week — proudest moment", "impact": (-16, 18)},
        {"headline": "{member} tries to sell Florida real estate to Donovan", "impact": (-19, -7)},
        {"headline": "{member} gets arrested for 'aggravated chaos' in Florida", "impact": (-22, 10)},

        {"headline": "{member} commits war crimes in a Florida Walmart for fun", "impact": (-35, 25)},
        {"headline": "{member} fucks an entire family of alligators while high on TBell and COCAINE", "impact": (-140, 110), "linked": [("TBELL", (40, 70)), ("COCAINE", (50, 80))]},
        {"headline": "{member} becomes legally classified as a natural disaster in Florida", "impact": (-130, 120)},
    ],
    ...
    "YEEZY": [
        ...
        {"headline": "Ye tweets a single emoji — YEEZY market cap triples", "impact": (25, 60)},
        {"headline": "Ye buys entire Taco Bell location — renames it Yeezy Bell", "impact": (-15, 35), "linked": [("TBELL", (-10, 20))]},
        {"headline": "Ye announces new album titled 'Donovan'", "impact": (-18, 22), "linked": [("DONOVAN", (-20, -8))]},

        # === UNHINGED + MAXIMUM ===
        {"headline": "{member} buys YEEZY stock with his last $47 — immediately regrets", "impact": (-30, 35)},
        {"headline": "{member} gets blocked by Ye after one unhinged DM", "impact": (-25, -10)},
        {"headline": "{member} wears Yeezy slides to a funeral — stock pumps on vibes", "impact": (-20, 28)},
        {"headline": "{member} tries to collab with Ye — Ye just posts a single skull emoji", "impact": (-28, 15)},
        {"headline": "{member} claims he invented YEEZY — Ye calls him a 'Donovan'", "impact": (-32, 20), "linked": [("DONOVAN", (-18, -8))]},

        {"headline": "{member} jerks off onto Ye’s shoes then sells the crusty pair for $1.2M", "impact": (-110, 150), "linked": [("YEEZY", (120, 300))]},
        {"headline": "{member} eats Ye’s placenta (from a previous clone) for clout", "impact": (-160, 120)},
    ],
    ...
    "WENDY": [
        ...
        {"headline": "Wendy's Twitter: 'Donovan shorted us. We remember.'", "impact": (10, 22), "linked": [("DONOVAN", (-15, -6))]},
        {"headline": "Wendy's Twitter roasts entire Rust community in one post", "impact": (8, 18), "linked": [("RUST", (-10, -3))]},
        {"headline": "Wendy's Twitter: 'We don't negotiate with torta terrorists'", "impact": (9, 20), "linked": [("TORTA", (-12, -5))]},
        {"headline": "Wendy's Twitter posts 'skill issue' at 3am — becomes financial advice", "impact": (12, 25)},
        {"headline": "Wendy's Twitter threatens legal action against Ohio", "impact": (7, 16), "linked": [("OHIO", (-20, 15))]},

        # === UNHINGED + MAXIMUM ===
        {"headline": "{member} gets absolutely cooked by Wendy's Twitter again", "impact": (-18, -6), "linked": [("WENDY", (15, 25))]},
        {"headline": "{member} slides into Wendy's Twitter DMs — gets publicly ratio'd", "impact": (-20, 8)},
        {"headline": "{member} tries to cancel Wendy's — square patties win", "impact": (-17, 12)},
        {"headline": "{member} eats Wendy's while shorting it — instant karma", "impact": (-19, -7)},
        {"headline": "{member} begs Wendy's Twitter for mercy — they post the receipts", "impact": (-22, 10)},

        {"headline": "{member} gets publicly dommed by Wendy's Twitter for 3 hours straight", "impact": (-35, -10), "linked": [("WENDY", (30, 50))]},
        {"headline": "{member} begs Wendy's Twitter for feet pics — becomes copypasta", "impact": (-40, 15)},
        {"headline": "{member} cums hands-free every time Wendy's posts a ratio", "impact": (-95, 130)},
        {"headline": "{member} gets turned into square patties after losing a bet to Wendy's account", "impact": (-140, -60)},
    ],
}
